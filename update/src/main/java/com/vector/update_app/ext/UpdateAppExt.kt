package com.vector.update_app.ext
...
fun Activity.updateApp(
    ...
    init: (UpdateAppManager.Builder.() -> Unit)? = null
): UpdateAppManager {
    val act = this
...
class Callback : UpdateCallback() {
    ...
    private var _hasNewApp: ((updateApp: UpdateAppBean, updateAppManager: UpdateAppManager) -> Unit)? =
        null
...
object UpdateAppInstance {
    var updateAppBean: UpdateAppBean? = null
}