...
public class RequestInterceptor implements Interceptor {
    ...
    public RequestInterceptor(FormatPrinter printer) {
        mPrinter = printer;
    }
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (handler != null)//这里可以比客户端提前一步拿到服务器返回的结果,可以做一些操作,比如token超时,重新获取
            return handler.onHttpResultResponse(bodyString, chain, originalResponse);
