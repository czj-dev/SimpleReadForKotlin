...
public final class ListUtils {
   ...
   */
  public static @Nullable
  <T> T find(final @NonNull List<T> xs, final @NonNull T y, final @NonNull BiFunction<T, T, Boolean> equality) {
   ...
   */
  public static @NonNull
  <T> List<T> intersection(final @NonNull List<T> lhs, final @NonNull List<T> rhs, final @NonNull BiFunction<T, T, Boolean> equality) {
    final List<T> result = new ArrayList<>();
    for (final T litem : lhs) {
      if (ListUtils.contains(rhs, litem, equality)) {
        result.add(litem);
