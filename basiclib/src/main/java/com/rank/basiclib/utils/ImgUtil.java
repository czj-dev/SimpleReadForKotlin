...
public class ImgUtil {
    ...
    public static Bitmap handleImageOnKitKat(Context context, Intent data) {
        String imagePath = getKitKatImagePath(context, data);
        return getImage(imagePath);
    }

    @Nullable
    public static String getKitKatImagePath(Context context, Intent data) {
    ...
    public static Bitmap getImage(String srcPath) {
        ...
        float hh = DensityUtil.dp2px(450);//这里设置高度为800f
        float ww = DensityUtil.dp2px(180);//这里设置宽度为480f
